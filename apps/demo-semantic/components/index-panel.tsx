    ...
    >
      ...
      {corpusIsStale ? (
        <p className="rounded-md border border-warn/40 px-2.5 py-2 text-[11px] leading-relaxed text-warn">
          data/articles.json has changed since the vectors were generated. Semantic results are ranking
          against the previous wording — run <span className="font-mono">pnpm corpus</span> to fix it.
        </p>
      ) : null}
    </Panel>
  )
