  ...
  return (
    <div className="zbs-searchbox zbs-demo-panel">
      ...
      <div className="zbs-searchbox__body">
            ...
            groups.map((group) => (
              <section key={group.id} className="zbs-searchbox__group">
                <header className="zbs-searchbox__group-title">
                  ...
                  {group.category ? (
                    <span className="zbs-searchbox__group-tag">{group.category}</span>
                  ) : null}
                </header>
                {group.hits.map((hit) => (
                  <div
        ...
        {trimmed === '' ? (
          <p className="zbs-searchbox__state zbs-searchbox__state--muted">
            Try “vector”, “facets”, or “cloudflare”.
          </p>
        ) : null}
