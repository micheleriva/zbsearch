---
title: API reference
description: Complete REST API for ZBSearch Edge - indexes, documents, search, rebuild, and status endpoints.
---
...
| `schema` | `object` | Yes | Same [schema types](/docs/zbsearch-js/usage/create) as standalone ZBSearch |
...
| `where` | `object` | - | Filters (same as [ZBSearch filters](/docs/zbsearch-js/search/filters)) |
| `limit` | `number` | `20` | Max results |
| `offset` | `number` | `0` | Pagination offset |
| `properties` | `string` \| `string[]` | - | Properties to search |
| `boost` | `object` | - | [Field boosting](/docs/zbsearch-js/search/fields-boosting) |
| `similarity` | `number` | - | Vector similarity threshold |
| `vector` | `{ value: number[], property: string }` | - | [Vector search](/docs/zbsearch-js/search/vector-search) query |
| `hybridWeights` | `{ text: number, vector: number }` | - | [Hybrid search](/docs/zbsearch-js/search/hybrid-search) weights |
