...
Search-heavy workloads benefit from Workers Cache reducing R2 reads. Write-heavy workloads append WAL entries and trigger periodic full snapshot rewrites.
