...
(Read more about database creation on the [create](/docs/zbsearch-js/usage/create) page)
...
To provide a custom ID for a document, see the [components](/usage/zbsearch-js/internals/components) page.
</Callout>
