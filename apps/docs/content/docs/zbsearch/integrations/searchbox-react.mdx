...
[Docusaurus](/docs/zbsearch/integrations/docusaurus) and [Starlight](/docs/zbsearch/integrations/starlight)
plugins render, published on its own so you can use it anywhere React runs.

If you are on Vue, [`@zbsearch/searchbox-vue`](/docs/zbsearch/integrations/searchbox-vue) is its exact
