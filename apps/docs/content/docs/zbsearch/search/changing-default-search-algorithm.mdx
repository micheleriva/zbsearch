...
If you want to know what search queries do your users perform, you can install the [Search Analytics plugin](/docs/zbsearch/plugins/plugin-analytics) to track and analyze search queries in your ZBSearch instance, for free.