...
BM25 indexes fastest. **PT15** wins every search case here (about **2.9×** BM25 on prefixes). **QPS** trades some throughput for proximity-aware ranking.
