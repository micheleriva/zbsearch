...
export function innerFullTextSearch(zbsearch, params, language) {
    ...
    if (term || properties) {
        ...
        uniqueDocsIDs = zbsearch.index.search(index, term || '', zbsearch.tokenizer, language, propertiesToSearch, params.exact || false, params.tolerance || 0, params.boost || {}, applyDefault(params.relevance), docsCount, whereFiltersIDs, threshold);
...
export function fullTextSearch(zbsearch, params, language) {
    ...
    function performSearchLogic() {
        ...
        if (params.groupBy) {
            searchResult.groups = getGroups(zbsearch, uniqueDocsArray, params.groupBy);
        }
